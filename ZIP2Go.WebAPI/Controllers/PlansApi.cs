...
namespace ZIP2GO.WebAPI.Controllers
{
    ...
    public class PlansController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePlan([FromBody] PlanCreateRequest body, [FromQuery] string zuoraTrackId, bool async = true)
        {
            var result = _plansService.CreatePlan(body, zuoraTrackId, async);
            return Ok(result);
        }
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public async Task<IActionResult> DeletePlan([FromRoute][Required] string planId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            _plansService.DeletePlan(planId, zuoraTrackId, async);
            return NoContent();
        }
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public async Task<IActionResult> GetPlan([FromRoute][Required] string planId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            if (string.IsNullOrEmpty(planId)) return BadRequest("planId cannot be null");
            if (string.IsNullOrEmpty(zuoraTrackId)) return BadRequest("zuoraTrackId cannot be null");

            var plan = _plansService.GetPlanCached(planId);
            if (plan is null) plan = _plansService.GetPlan(planId, zuoraTrackId, async);
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public async Task<IActionResult> GetPlans([FromQuery] string zuoraTrackId, bool async = true)
        {
            var plans = _plansService.GetPlansCached();

            if (plans.Data.Count() == 0) plans = _plansService.GetPlans(zuoraTrackId, async);
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public async Task<IActionResult> UpdatePlan([FromBody] PlanPatchRequest body, [FromRoute][Required] string planId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            var result = _plansService.UpdatePlan(body, planId, zuoraTrackId, async);
            return Ok(result);
        }
    }
}