...
namespace ZIP2GO.WebAPI.Controllers
{
    ...
    public class SubscriptionItemsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetSubscriptionItems([FromQuery] string cursor, string zuoraTrackId, bool async = true)
        {
            var subscriptionItems = _subscriptionItemsService.GetSubscriptionItemsCached();

            if (subscriptionItems.Data.Count() == 0) subscriptionItems = _subscriptionItemsService.GetSubscriptionItems(cursor, zuoraTrackId, async);
