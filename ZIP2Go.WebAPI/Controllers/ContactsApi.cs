...
namespace ZIP2GO.WebAPI.Controllers
{
    ...
    public class ContactsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateContact([FromBody] ContactCreateRequest body, [FromQuery] string zuoraTrackId, bool async = true)
        {
            var result = _contactsService.CreateContact(body, zuoraTrackId, async);
        ...
        public async Task<IActionResult> DeleteContact([FromRoute][Required] string contactId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            _contactsService.DeleteContact(contactId, zuoraTrackId, async);
        ...
        public async Task<IActionResult> GetContact([FromRoute][Required] string contactId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            if (string.IsNullOrEmpty(contactId)) 
            {
                return BadRequest("contactId cannot be null");
            }
            ...
            var contact = _contactsService.GetContactCached(contactId);
            if (contact is null) 
            {
                contact = _contactsService.GetContact(contactId, zuoraTrackId, async);
            }
        ...
        public async Task<IActionResult> GetContacts([FromQuery] string zuoraTrackId, bool async = true)
        {
            var contacts = _contactsService.GetContactsCached();

            if (contacts.Data.Count() == 0) 
            {
                contacts = _contactsService.GetContacts(zuoraTrackId, async);
            }
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public async Task<IActionResult> ScrubContact([FromRoute][Required] string contactId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            _contactsService.ScrubContact(contactId, zuoraTrackId, async);
        ...
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Contact not found")]
        public async Task<IActionResult> UpdateContact([FromBody] ContactPatchRequest body, [FromRoute][Required] string contactId, [FromQuery] string zuoraTrackId, bool async = true)
        {
            var result = _contactsService.UpdateContact(body, contactId, zuoraTrackId, async);
